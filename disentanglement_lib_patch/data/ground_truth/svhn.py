...
class SVHN(ground_truth_data.GroundTruthData):
    """
    SVHN dataset.
    """
    ...
    def __init__(self, split_type, equal_factors=False):
        ...
        train_flag = 'train' if split_type == 'train' else 'test'
        
        # Load CIFAR-10 dataset
        dataset = torchvision.datasets.SVHN(root='', split=train_flag, download=True)
